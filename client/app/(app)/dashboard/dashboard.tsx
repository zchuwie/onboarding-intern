...
export default function Dashboard() {
    return (
        <div className="p-8 max-w-7xl mx-auto">
            <div className="mb-8">
                <h1 className="text-3xl font-semibold tracking-tight mb-1">Good afternoon, User.</h1>
                <p className="text-gray-500">Here is an overview of your document intelligence workspace.</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="text-xs font-medium text-gray-500 uppercase tracking-wider">Total Files</h3>
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="text-xs font-medium text-gray-500 uppercase tracking-wider">Total Chats</h3>
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-200 flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="text-xs font-medium text-gray-500 uppercase tracking-wider">AI Responses</h3>
                        <p className="text-2xl font-semibold mt-1">1,048</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 flex flex-col">
                    <h2 className="text-xl font-medium mb-6">Quick Upload</h2>
                    <div className="flex-1 flex flex-col items-center justify-center border-2 border-dashed border-gray-200 rounded-xl p-12 text-center bg-neutral-50 hover:border-black transition-colors cursor-pointer">
                        ...
                        <p className="text-xs text-gray-400 mt-4">Supports PDF, DOCX, TXT, CSV</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-6 min-w-0">
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        <h2 className="text-xl font-medium mb-6">Recent Recommendations</h2>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-medium">Context Sources</h2>
                            <Link href="/documents" className="text-sm text-gray-500 hover:text-black transition-colors">View All</Link>
                        </div>
